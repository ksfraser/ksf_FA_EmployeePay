...
| FR-EP-001-004 | Canadian statutory deductions (CPP/EI/Tax progressive) | `src/Service/DeductionService.php`, `sql/install.sql` | `tests/Unit/DeductionServiceTest.php` |
| FR-EP-001-005 | GL posting per mode (incoming/outgoing) | `pages/settings.php`, `sql/install.sql` | `tests/Unit/GLServiceTest.php` (planned) |
| FR-EP-001-006 | Reimbursements / Expense section | `pages/reimburse.php`, `sql/install.sql` | `tests/Unit/ReimbursementServiceTest.php` (planned) |
| FR-EP-001-007 | Pay stub sections (Income 1, Pension 2, Tax 3, Other 4, Net 5) | `sql/install.sql`, `pages/sections.php` | `tests/Unit/CalculationServiceTest.php` |
